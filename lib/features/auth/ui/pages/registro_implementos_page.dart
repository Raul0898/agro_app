...
class RegistroImplementosPage extends StatelessWidget {
  const RegistroImplementosPage({super.key});
  ...
  Widget build(BuildContext context) {
    return MiniIconRailScaffold(
      title: 'Registro de Implementos',
      items: _items(context),
      currentIndex: 5,
      block: AppBlock.servicios,
      body: const Center(
        child: Text('Pantalla de Registro de Implementos', style: TextStyle(fontSize: 18)),
      ),
    );
  }
}
