...
class ReporteActividadFormPage extends StatefulWidget {
  ...
  final String coleccionDestino; // fijo: reportes_compactacion
...
class _ReporteActividadFormPageState extends State<ReporteActividadFormPage> {
  ...
  String _incidenciaPath(String fileName) {
    ...
    return 'unidades_info/$u/analisis_suelo/img/incidencias_img/$_year/${_month2()}/$fileName';
  }
  ...
  String _pdfPath() {
    final u = _sanitizeSegment(_unidad);
    final name = 'reporte_compactacion_${_ts()}.pdf';
  ...
  Future<(String path, String url)> _uploadBytes(Uint8List data, String path,
    ...
    final metadata = SettableMetadata(
      ...
      customMetadata: {
        if (uid != null) 'uid': uid,
        'unidad': _unidad,
        'tipo': 'reporte_actividad_compactacion',
      },
    );
