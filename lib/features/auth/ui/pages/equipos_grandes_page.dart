// lib/features/auth/ui/pages/equipos_grandes_page.dart
...
class EquiposGrandesPage extends StatelessWidget {
  const EquiposGrandesPage({super.key});
  ...
  Widget build(BuildContext context) {
    return MiniIconRailScaffold(
      ...
      body: const Center(
        child: Text('Pantalla de Equipos Grandes', style: TextStyle(fontSize: 18)),
      ),
    );
  }
}
