...
class EquiposPequenosPage extends StatelessWidget {
  const EquiposPequenosPage({super.key});
  ...
  Widget build(BuildContext context) {
    return MiniIconRailScaffold(
      ...
      body: const Center(
        child: Text('Pantalla de Equipos Pequeños', style: TextStyle(fontSize: 18)),
      ),
    );
  }
}
